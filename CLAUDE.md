# Itihas — Claude Code Instructions
...
sankhya (ancient math), avatara (simulation), kiran (game engine), joshua (strategy), jnana (knowledge), lipi (linguistics), vidya (programming reference)
